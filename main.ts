...
namespace msmSmartTools {
    ...
    export function suiviDeLigne(): void {
        ...
        else if (capteur1) tournerAGauche(vitesseCorrection)
        else if (capteur4) tournerADroite(vitesseCorrection)
